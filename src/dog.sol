...
contract Dog {
    // --- Auth ---
    //Same style of auth we have in all the other contracts
    ...
    struct Ilk {
        ...
        //*** TODO Not sure what the difference between hole and dirt is right now
    ...
    //*** immutable means it can only be assigned in constructor, like readonly in C# */
