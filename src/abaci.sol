...
//*** Abacus just has once function which returns the current auction price  it is simply given the starting price and time since the auction start */
//*** Various different contracts implement this interface and use a different strategy for price decrease e.g. linear */
